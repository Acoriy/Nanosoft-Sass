...
const BlogAdmin = () => {
  ...
  // Chargement des blogs depuis Firebase sans initialiser de données par défaut
  useEffect(() => {
    const loadBlogs = async () => {
      ...
      try {
        ...
        console.error("حدث خطأ أثناء تحميل المدونات:", error);
  ...
  const refreshBlogs = async () => {
    try {
      ...
      console.error("حدث خطأ أثناء تحديث المدونات:", error);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      console.error("حدث خطأ أثناء حذف المدونة:", error);
  ...
  const handleUpdateBlog = async () => {
    try {
      ...
      setBlogs(blogs.map(blog => blog.id === editingBlog.id ? { ...blog, ...editingBlog } : blog));
      setIsEditDialogOpen(false);
      toast.success("تم تحديث المدونة بنجاح");
    } catch (error) {
      console.error("حدث خطأ أثناء تحديث المدونة:", error);
  ...
  const handleAddBlog = async () => {
    try {
      ...
      console.error("حدث خطأ أثناء إضافة المدونة:", error);
  ...
  const togglePublish = async (id: string) => {
    try {
      ...
      setBlogs(blogs.map(blog => blog.id === id ? { ...blog, published: newPublishState } : blog));
                    ...
                    <TableRow key={blog.id}>
                      ...
                      <TableCell>
                        <Button
                          ...
                          className={blog.published ? "bg-green-500 hover:bg-green-600" : "text-gray-500"}
                        >
          ...
          {editingBlog && (
            <Tabs defaultValue="details">
              ...
              <TabsContent value="details">
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="edit-title" className="text-right">العنوان</Label>
                    <Input
                      id="edit-title"
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="edit-excerpt" className="text-right">ملخص</Label>
                    <Input
                      id="edit-excerpt"
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="edit-category" className="text-right">الفئة</Label>
                    <Input
                      id="edit-category"
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="edit-date" className="text-right">التاريخ</Label>
                    <Input
                      id="edit-date"
                      type="date"
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="col-span-3 flex items-center gap-2">
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          setEditingBlog({ ...editingBlog, published: true })
                        }
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          setEditingBlog({ ...editingBlog, published: false })
                        }
              ...
              <TabsContent value="content">
                <div className="grid gap-4 py-4">
                  <div>
                    <Label htmlFor="edit-content" className="mb-2 block">المحتوى</Label>
                    <Textarea
                      id="edit-content"
              ...
              <TabsContent value="image">
                <div className="grid gap-4 py-4">
                  <div className="space-y-4">
                    <Label className="block">الصورة</Label>
                    {editingBlog.image && (
