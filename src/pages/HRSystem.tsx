...
const features = [
  {
    title: "إدارة بيانات الموظفين",
    icon: <Users className="h-8 w-8 text-nanosoft-primary" aria-hidden="true" />,
    description:
      "إدارة شاملة لبيانات الموظفين وملفاتهم الشخصية والمهنية والمستندات الخاصة بهم",
  },
  {
    title: "إدارة الإجازات والمغادرات",
    icon: <Calendar className="h-8 w-8 text-nanosoft-primary" aria-hidden="true" />,
    description:
      "إدارة كاملة لإجازات الموظفين واستحقاقاتهم وتتبع الغياب والمغادرات",
  },
  {
    title: "تتبع الحضور والانصراف",
    icon: <Clock className="h-8 w-8 text-nanosoft-primary" aria-hidden="true" />,
    description:
      "نظام مرن لتسجيل الحضور والانصراف ومراقبة ساعات العمل الفعلية للموظفين",
  },
  {
    title: "إدارة الرواتب والتعويضات",
    icon: <Briefcase className="h-8 w-8 text-nanosoft-primary" aria-hidden="true" />,
    description:
      "حساب الرواتب والبدلات والعلاوات والخصومات بشكل آلي مع إصدار المستندات اللازمة",
  },
  {
    title: "تقييم الأداء",
    icon: <Award className="h-8 w-8 text-nanosoft-primary" aria-hidden="true" />,
    description:
      "إدارة عمليات تقييم الأداء الدورية للموظفين ووضع الأهداف وقياس الإنجازات",
  },
  {
    title: "التقارير والإحصائيات",
    icon: <BarChart className="h-8 w-8 text-nanosoft-primary" aria-hidden="true" />,
    description:
      "تقارير متنوعة وشاملة حول جميع جوانب إدارة الموارد البشرية لاتخاذ القرارات",
  },
];
    ...
    <main className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 pt-28 md:pt-32" lang="ar">
      ...
      <section className="flex flex-col md:flex-row items-center gap-10 my-16">
        ...
        >
          ...
          <p className="text-gray-600 text-lg mb-8">
            يوفر لك برنامج إدارة شؤون الموظفين من نانوسوفت حلاً متكاملاً لإدارة جميع جوانب الموارد البشرية من تسجيل البيانات وإدارة الإجازات إلى احتساب الرواتب وتقييم الأداء.
          </p>
          <div className="flex flex-wrap gap-4 justify-end">
            <Link to="/contact">
              <Button className="bg-nanosoft-primary hover:bg-nanosoft-primary/90" aria-label="طلب عرض توضيحي">
                طلب عرض توضيحي
              </Button>
            </Link>
            <Link to="/pricing">
              <Button variant="outline" aria-label="تعرف على المزيد">
                تعرف على المزيد
              </Button>
            </Link>
          </div>
      ...
      <section className="my-20">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold">حلول متكاملة لإدارة الموارد البشرية</h2>
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            يوفر نظام إدارة الموارد البشرية من نانوسوفت مجموعة شاملة من الأدوات التي تلبي احتياجات مؤسستك.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 rtl">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-100 text-right"
            >
              <div className="mb-4 flex justify-end" aria-hidden="true">{feature.icon}</div>
              <h3 className="text-xl font-semibold mb-3">{feature.title}</h3>
              <p className="text-gray-600">{feature.description}</p>
            </motion.div>
          ))}
      ...
      <section className="my-20 bg-gradient-to-r from-nanosoft-primary/5 to-nanosoft-primary/10 rounded-2xl p-8 lg:p-12">
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="flex-1 text-right">
            ...
            <Link to="/pricing">
              <Button className="mt-8 bg-nanosoft-primary hover:bg-nanosoft-primary/90" aria-label="ابدأ الآن مجاناً">
                ابدأ الآن مجاناً
              </Button>
            </Link>
          </div>
      ...
      <section className="my-20 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto mb-8">
          إنضم إلى المؤسسات التي تستخدم نظام إدارة الموارد البشرية من نانوسوفت لإدارة شؤون موظفيها بكفاءة.
        </p>
        <div className="flex flex-wrap gap-4 justify-center">
          <Link to="/pricing">
            <Button className="bg-nanosoft-primary hover:bg-nanosoft-primary/90 px-8 py-6 text-lg" aria-label="ابدأ الاشتراك مجانا">
              ابدأ الاشتراك مجانا
            </Button>
          </Link>
          <Link to="/contact">
            <Button variant="outline" className="px-8 py-6 text-lg" aria-label="تواصل مع فريق المبيعات">
              تواصل مع فريق المبيعات
            </Button>
          </Link>
        </div>
