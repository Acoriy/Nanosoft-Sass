    ...
    const fetchBlogData = async () => {
      ...
      try {
        ...
        if (blogData) {
          ...
          // Filter for published blogs and by category
    ...
    return (
      <div className="min-h-screen pt-24 pb-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8">عذراً، لم نتمكن من العثور على المقال الذي تبحث عنه.</p>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-nanosoft-primary/20 flex items-center justify-center text-nanosoft-primary font-semibold text-lg ml-3">
            ...
            {post.image ? (
              <img
                ...
                onError={(e) => {
                  ...
                  target.src = "https://images.unsplash.com/photo-1518770660439-4636190af475"; // Fallback image
                }}
              />
            ) : (
          ...
          >
            <h3 className="text-xl font-bold mb-6">شاركنا رأيك</h3>
