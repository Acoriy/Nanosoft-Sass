        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              نقدم مجموعة شاملة من الخدمات المصممة لمساعدة شركتك على النمو والازدهار في العالم الرقمي.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-nanosoft-primary/20 flex items-center justify-center ml-3 mt-1" aria-hidden="true">
                    <svg className="w-3 h-3 text-nanosoft-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"/>
                    </svg>
                  </div>
                  <p className="text-gray-600">فريق من المطورين المحترفين ذوي الخبرة العالية</p>
                </div>
                <div className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-nanosoft-primary/20 flex items-center justify-center ml-3 mt-1" aria-hidden="true">
                    <svg className="w-3 h-3 text-nanosoft-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-600">نهج مخصص يركز على احتياجات العميل</p>
                </div>
                <div className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-nanosoft-primary/20 flex items-center justify-center ml-3 mt-1" aria-hidden="true">
                    <svg className="w-3 h-3 text-nanosoft-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-600">تقنيات متطورة وأحدث الأدوات لتقديم أفضل النتائج</p>
                </div>
                <div className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-nanosoft-primary/20 flex items-center justify-center ml-3 mt-1" aria-hidden="true">
                    <svg className="w-3 h-3 text-nanosoft-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-600">دعم مستمر ومتابعة لضمان رضا العملاء</p>
                </div>
              </div>
              <LinkScroll
                to="services"
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
              <div className="p-10 md:p-16 text-white">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">جاهز لتطوير أعمالك؟</h2>
                <p className="text-white/80 text-lg mb-8">
                  دعنا نساعدك في تحويل أفكارك إلى حلول رقمية مبتكرة. اتصل بنا اليوم للحصول على استشارة مجانية وابدأ رحلتك نحو النجاح الرقمي.
                </p>
